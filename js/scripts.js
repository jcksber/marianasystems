...
mr = (function (mr, $, window, document){
    ...
    var documentReady = function($){
        ...
        /////////////// Setup the original error for forms
            ...
            if(typeof window.google.maps !== "undefined"){
                $('.map-container[data-maps-api-key]').each(function(){
                    var mapInstance   = this,
                        ...
                        address       = typeof $(this).attr('data-address') !== typeof undefined ? $(this).attr('data-address').split(';'): false,
                    ...
                    if(address != undefined && address[0] != ""){
                            geocoder.geocode( { 'address': address[0].replace('[nomarker]','')}, function(results, status) {
                                ...
                                address.forEach(function(address){
                                    ...
                                    markerImage = {url: window.mr_variant == undefined ? markerImage : '../img/mapmarker.png', size: new google.maps.Size(50,50), scaledSize: new google.maps.Size(50,50)};
...
mr = (function (mr, $, window, document){
    ...
    var documentReady = function($){
        ...
        $('.modal-trigger').click(function(){
            ...
            $('.modal-text').css('overflowY','scroll');
        ...
        $('.modal-container').on('click', function(e) { 
            ...
            $('.modal-text').css('overflow','hidden');
            mr.modals.closeActiveModal();
        });
