...
$outgoingServerAddress      = 'mail.marianasystems.com'; // Consult your hosting provider.
$outgoingServerPort         = '21';                  // Options: '587' , '25' - Consult your hosting provider.
...
$sendingAccountEmailAddress = 'hello@marianasystems.com ';
$sendingAccountUsername     = 'marianasystems';
$sendingAccountPassword     = 'Jell0Star';

// Recipient (To:) Details  - Change this to the email details of who will receive all the emails from the website.
$recipientEmail             = 'jkramer@marianasystems.com'; // REQUIRED value.
$recipientName              = 'Jeff Kramer';             // REQUIRED value.

// Email details            - Change these to suit your website needs
$emailSubject               = 'Inquiring about Mariana Systems!'; // REQUIRED value. Subject of the email that the recipient will see
$websiteName                = 'Mariana Systems';                // REQUIRED value. This is used when a name or email is not collected from the website form

$timeZone					          = 'Central';         // OPTIONAL, but some servers require this to be set. 
